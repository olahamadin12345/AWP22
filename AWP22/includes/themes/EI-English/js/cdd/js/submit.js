...
//              }
            ...
            alert('Thank you for the submission. Please note your reference id: '+parsedjson.PID);
                window.location = "/eng/kyc/cdd/cdd-authentication/";
              }
        }
    });
}
...
/* edunext server validation check*/
  ...
  ////alert('sec2')
    ...
    strProfession =$("#drpprofession").val();
    ...
    fd.append('drpprofession',strProfession);
        ...
        //alert(response);
            ...
            $.each(parsedjson, function(i, item) {
              ...
              else
              {
                ...
                $("#headingC").removeClass("accodheader");
                $("#headingCa").removeClass("accodheader");
                $("#nonindAMTback").removeClass("displaynone");
                $("#nonindAMTback").addClass("displayblock");
